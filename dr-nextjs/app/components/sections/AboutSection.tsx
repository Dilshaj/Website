                ...
                <div className="mxd-block">
                    <div className="container-fluid px-0">
                        <div className="row gx-0">
                            <div className="col-12 col-lg-5 mxd-grid-item no-margin">
                            ...
                            <div className="col-12 col-lg-7 mxd-grid-item no-margin">
                                <div className="mxd-block__content">
                                    <div className="mxd-block__manifest">
                                        <p className="mxd-manifest reveal-type anim-uni-in-up">
                                            Dilshaj Infotech is a future focused technology company offering training, digital solutions, and innovative products.
                                        </p>
                                        <div className="mxd-manifest__controls anim-uni-in-up">
                                            <a className="btn btn-anim btn-default btn-outline slide-right-up anim-uni-in-up" href="https://api.whatsapp.com/send?phone=918977272783&text=Hello.">
